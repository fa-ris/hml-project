...
class FedDropAdam(Strategy):
    ...
    def configure_fit(
        ...
        for client in clients:
            if (client.cid in self.straggler) and rnd > 1:
                ...
                fit_ins_drop = FitIns(self.drop_dynamic(parameters, p_val, [0,4], 2, client.cid), config_drop)
    ...
    def aggregate_fit(
        ...
        fedavg_weights_aggregate = aggregated_weights
